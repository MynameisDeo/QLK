...
<div class="login-box">
  <div class="login-logo">
    <a href="${pageContext.request.contextPath }/resources/admin/index2.html"><b>Login</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <a href="${pageContext.request.contextPath }/account/register" class="btn btn-block btn-danger">
