...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a class="brand-link">
      ...
      <span class="brand-text font-weight-light">StorehouseLTE</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Welcome ${pageContext.request.userPrincipal.name }</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
       ...
       <!--   ---------------------------------------ALO ALO CHÚ Ý----------------------------------------------- -->
          <li class="nav-item">
            <a href="${pageContext.request.contextPath }/account/welcome" class="nav-link">
          ...
          <li class="nav-item">
            <a href="${pageContext.request.contextPath }/account/logout" class="nav-link">
